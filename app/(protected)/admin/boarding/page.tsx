...
export default function AdminBoardingPage() {
    ...
    const {
        ...
        adminUpdateListing, adminDeleteListing, loadPlatformStats,
    ...
    return (
        <>
            <BoardingHouseCommon
                title="Boarding House Administration"
                description="Manage all boarding house listings across the platform"
                overviewStats={stats}
                mainTab={mainTab}
                onMainTabChange={handleTabChange}
                isLoading={isListingLoading || isStatsLoading}
                onRefresh={handleRefresh}
                tabLabels={['All Listings (Admin)', 'My Listings']}
            >
            ...
            <Dialog open={deleteConfirmOpen} onClose={() => setDeleteConfirmOpen(false)} maxWidth="xs" fullWidth>
                ...
                <DialogContent>
                    <Typography>Are you sure you want to delete &quot;{deleteListing?.title}&quot;? This will soft-delete the listing regardless of ownership.</Typography>
                </DialogContent>
                <DialogActions>
