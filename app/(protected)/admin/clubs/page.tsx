...
/**
 * Admin Club Management — Full Administration
 * All CRUD + delete clubs + admin operations
 */
        ...
        <Box sx={{ maxWidth: 1400, mx: 'auto', p: { xs: 2, sm: 3 } }}>
            ...
            <MotionBox initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                    <Box>
                        <Typography variant="h4" fontWeight={700}>Full Club Administration</Typography>
                        <Typography variant="body2" color="text.secondary">
                            Complete management of all clubs, memberships, announcements & elections
                        </Typography>
                    </Box>
                ...
                <Tabs value={activeTab} onChange={(_, v) => setActiveTab(v)} sx={{ mb: 3 }}>
                    ...
                    {selectedClub && <Tab label={`${selectedClub.name} — Administration`} />}
                </Tabs>
            </MotionBox>
            ...
            {/* Tab 1: Club Detail Administration */}
