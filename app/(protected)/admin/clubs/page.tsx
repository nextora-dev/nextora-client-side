...
/**
 * Admin Club Management — Club List
 * Click any club to navigate to /admin/clubs/[id] for full administration
 */
export default function AdminClubsPage() {
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            if (searchQuery.trim()) {
                // Try code search if looks like a club code (e.g., "CS-001"), otherwise keyword
    ...
    return (
        <ClubCommon
            ...
            description="Manage all university clubs — click a club for full administration"
