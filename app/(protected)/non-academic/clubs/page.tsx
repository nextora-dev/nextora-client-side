...
/**
 * Non-Academic Staff Club Management — Club List
 * Click any club to navigate to /non-academic/clubs/[id] for management
 */
export default function NonAcademicClubsPage() {
    ...
    const handleViewClub = (club: ClubResponse) => {
        router.push(`/non-academic/clubs/${club.id}`);
    };
    ...
    return (
        <ClubCommon
            ...
            description="Manage clubs, members & activities — click a club for details"
