...
export const STUDENT_NAVIGATION: NavigationItem[] = [
    ...
    { id: 'kuppi', label: 'Kuppi Sessions', icon: AutoStoriesIcon, path: '/student/kuppi', badge: 0 },
    { id: 'events', label: 'Events', icon: ConfirmationNumberIcon, path: '/student/events', badge: 0 },
    { id: 'clubs', label: 'Clubs', icon: GroupsIcon, path: '/student/clubs', badge: 0 },
    { id: 'voting', label: 'Elections', icon: HowToVoteIcon, path: '/student/voting', badge: 0, clubMembersOnly: true },
    { id: 'lostandfound', label: 'Lost & Found', icon: SearchIcon, path: '/student/lost-found', badge: 0 },
...
export const ACADEMIC_STAFF_NAVIGATION: NavigationItem[] = [
    ...
    { id: 'kuppi', label: 'Kuppi Sessions', icon: AutoStoriesIcon, path: '/academic/kuppi', badge: 0 },
    { id: 'clubs', label: 'Clubs', icon: GroupsIcon, path: '/academic/clubs', badge: 0 },
    { id: 'events', label: 'Events', icon: ConfirmationNumberIcon, path: '/academic/events', badge: 0 },
    { id: 'meetings', label: 'Student Meetings', icon: PersonIcon, path: '/academic/meetings', badge: 0 },
...
export const NON_ACADEMIC_STAFF_NAVIGATION: NavigationItem[] = [
    ...
    { id: 'events', label: 'Events Support', icon: EventIcon, path: '/non-academic/events', badge: 0 },
    { id: 'clubs', label: 'Club Management', icon: GroupsIcon, path: '/non-academic/clubs', badge: 0 },
    { id: 'boarding', label: 'Boarding Houses', icon: ApartmentIcon, path: '/non-academic/boarding', badge: 0 },
    { id: 'lostandfound', label: 'Lost & Found', icon: SearchIcon, path: '/non-academic/lost-found', badge: 0 },
...
export const ADMIN_NAVIGATION: NavigationItem[] = [
    ...
    { id: 'events', label: 'Event Management', icon: EventIcon, path: '/admin/events', badge: 0 },
    { id: 'boarding', label: 'Boarding Houses', icon: ApartmentIcon, path: '/admin/boarding', badge: 0 },
    { id: 'lostandfound', label: 'Lost & Found', icon: SearchIcon, path: '/admin/lost-found', badge: 0 },
    { id: 'clubs', label: 'Club Management', icon: GroupsIcon, path: '/admin/clubs', badge: 0 },
    { id: 'meetings', label: 'Meeting Management', icon: PersonIcon, path: '/admin/meetings', badge: 0 },
    { id: 'approvals', label: 'Approvals', icon: VerifiedUserIcon, path: '/admin/approvals', badge: 0 },
...
export const SUPER_ADMIN_NAVIGATION: NavigationItem[] = [
    ...
    { id: 'events', label: 'Event Management', icon: EventIcon, path: '/super-admin/events', badge: 0 },
    { id: 'boarding', label: 'Boarding Houses', icon: ApartmentIcon, path: '/super-admin/boarding', badge: 0 },
    { id: 'lostandfound', label: 'Lost & Found', icon: SearchIcon, path: '/super-admin/lost-found', badge: 0 },
    { id: 'clubs', label: 'Club Management', icon: GroupsIcon, path: '/super-admin/clubs', badge: 0 },
    { id: 'meetings', label: 'Meeting Management', icon: PersonIcon, path: '/super-admin/meetings', badge: 0 },
    { id: 'system', label: 'System Health', icon: StorageIcon, path: '/super-admin/system', badge: 0 },
    { id: 'security', label: 'Security', icon: SecurityIcon, path: '/super-admin/security', badge: 0 },
...
/**
 * Filter navigation items based on club membership
 * Club members-only items are hidden if user is not a club member
 */
export function filterNavigationByClubMembership(items: NavigationItem[], isClubMember: boolean): NavigationItem[] {
    return items.filter(item => !item.clubMembersOnly || isClubMember);
}
