...
import type { AcceptMeetingRequest, MeetingResponse } from '@/features/meeting/types';
...
interface AcceptMeetingDialogProps {
    ...
    onSubmit: (data: AcceptMeetingRequest) => void;
}

export default function AcceptMeetingDialog({ open, onClose, isSubmitting, meeting, onSubmit }: AcceptMeetingDialogProps) {
                ...
                <Stack spacing={2.5} sx={{ pt: 1 }}>
                    {meeting && (
                        <Typography variant="body2" color="text.secondary">
                            Accepting meeting request: <strong>{meeting.subject}</strong> from {meeting.studentName}
                        </Typography>
                    )}
                    <TextField
